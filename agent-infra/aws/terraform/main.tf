...
# ECR Repositories
resource "aws_ecr_repository" "example_api" {
...
resource "aws_ecr_repository" "agent_api" {
  name                 = "${var.project_name}/agent-api"
  image_tag_mutability = "MUTABLE"
...
resource "aws_ecr_lifecycle_policy" "example_api" {
  repository = aws_ecr_repository.example_api.name
